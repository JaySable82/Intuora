...
const YourComponent = ({ cart, updateCart,selectedTable,tableno,blockNo,isOpen,setIsOpen }) => {
    ...
    return (
        ...
        <div style={isOpen ? {top:200,left:340,height:1000,width:750,position:"absolute",backgroundColor:"#F8F8FA",borderRadius:10,overflowY:"auto", transition:"0.5s ease"} : {top:200,left:40,height:1000,width:1000,position:"absolute",backgroundColor:"#F8F8FA",borderRadius:10,overflowY:"auto",transition:"0.5s ease"}}> 
            <Categories sectionRefs={sectionRefs}/>
